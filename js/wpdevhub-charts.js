...
var DSCF_DLM_Admin = {
    ...
    loadGoogle:function(){
        if(DSCF_DLM_Charts.isGoogleLoaded){
            ...
            script.src = "https://www.google.com/jsapi?callback=DSCF_DLM_Charts.loadGoogleVisualization";
    ...
    loadGoogleVisualization:function(){
        ...
        if(DSCF_DLM_Charts.isGoogleVisLoaded){
            ...
            google.load("visualization", "1", {'packages':['corechart','annotationchart','gauge', 'timeline', 'bar'], "callback" : DSCF_DLM_Charts.drawGoogleCharts});
        }
    },
    ...
    addChart:function(elementId, chartTypeId, data, options){
        ...
        newChart.data = data;
        newChart.options = options;
        DSCF_DLM_Charts.chartsToDo.push(newChart);
        DSCF_DLM_Charts.drawGoogleCharts();
    },
    ...
    drawGoogleCharts:function(){
        ...
        setTimeout(function(){
            ...
            while(DSCF_DLM_Charts.chartsToDo.length > 0){
                var chartObject = DSCF_DLM_Charts.chartsToDo[0];
                ...
                DSCF_DLM_Charts.arrayRemove(DSCF_DLM_Charts.chartsToDo, 0);
            }
        }, 500);
    },
    ...
    this.performAjax = function(){
        ...
        $.ajax({
            ...
            success: function(responseData) {
                ...
                DSCF_DLM_Charts.chartsToDo.push(this.chartObject);
                DSCF_DLM_Charts.drawGoogleCharts();
            },
