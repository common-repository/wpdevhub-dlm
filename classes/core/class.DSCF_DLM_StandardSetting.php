 ...
 */
class DSCF_DLM_StandardSetting{
    ...
    public static function saveToDb($settingName, $settingValue){
        $settingName = 'DSCF_DLM_'.$settingName;
    ...
    */
    ...
    public static function getSettingsObject($options=array()){
        $settingsObject = new DSCF_DLM_StandardSetting();
    ...
    public static function saveSettingsObject($settingsObject, $options=array()){
        if(!empty($options)){
            ...
            //DSCF_DLM_Utilities::addUserMessage('Settings Saved Successfully');
        }
    }
