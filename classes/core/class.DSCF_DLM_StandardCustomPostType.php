 ...
 */
class DSCF_DLM_StandardCustomPostType{
    ...
    public static function get_display($content){
        DSCF_DLM_Utilities::logMessage("get_display.  Wrong place to be - in the parent");
        return $content;
    }
    ...
    public static function getAllPostObjectsAsMenuArray(){
        ...
        $array = DSCF_DLM_StandardObjectRecord::getBasicArrayFromObjects($posts, 'post_title', 'ID');
        return $array;
    }
    ...
    */
    ...
    public static function getVirtualPagesPostList($params){
        ...
        DSCF_DLM_Utilities::logMessage("PAGINATION VARS: ".print_r($paginationVars, true));
        $pagination = get_the_posts_pagination($paginationVars);
        $html .= $pagination;
        DSCF_DLM_Utilities::logMessage("PAGINATION: ".$pagination);
        */
    ...
    */
    public static function shortcodeHandlerDisplayGenericPostType($atts, $id_field){
        ...
        $post_id = DSCF_DLM_Utilities::getFromArray($id_field, $data, 0);
    ...
    public static function helperBuildTitleArrayForParentId($parentPostObject, $postsByParent){
        ...
        $childPosts = DSCF_DLM_Utilities::getFromArray($parentPostObjectId, $postsByParent);
        //DSCF_DLM_Utilities::logMessage("helperbuildIdentificationArrayForParentId Child Identifications Found for ParentID[$parentPostObjectId]: ".print_r($childPosts, true));
        ...
        if(!empty($childPosts)){
            ...
            //DSCF_DLM_Utilities::logMessage("helperbuildIdentificationArrayForParentId BEFORE SORT Array: ".print_r($childPosts, true));
            ...
            //DSCF_DLM_Utilities::logMessage("helperbuildIdentificationArrayForParentId AFTER SORT Array: ".print_r($childPostsBySlug, true));
        ...
        //DSCF_DLM_Utilities::logMessage("helperbuildIdentificationArrayForParentId Return Array: ".print_r($returnArray, true));
    ...
    public static function helperSortPostsByHierarchy($posts){
        ...
        //DSCF_DLM_Utilities::logMessage("Unsorted Identifications Only By Parent ID: ".print_r($postsByParent, true));
        ...
        //DSCF_DLM_Utilities::logMessage("Sorted Identifications By Parent ID: ".print_r($finalArray, true));
    ...
    public static function getPostsWithHierarchyForMenu($sortedPosts, $menuArray=array(), $existingPrefix=""){
        ...
        //DSCF_DLM_Utilities::logMessage("Sorted Identifications Passed in: ".print_r($sortedPosts, true));
        foreach($sortedPosts as $postArray){

            $post = DSCF_DLM_Utilities::getFromArray('location', $postArray, null);
            $children = DSCF_DLM_Utilities::getFromArray('children', $postArray, array());
        ...
        //DSCF_DLM_Utilities::logMessage("Menu Array Being Return: ".print_r($menuArray, true));
        return $menuArray;
