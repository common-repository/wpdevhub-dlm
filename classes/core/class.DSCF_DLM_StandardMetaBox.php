 ...
 */
class DSCF_DLM_StandardMetaBox{
    ...
    public static function getClassName(){
        ...
        //DSCF_DLM_Utilities::logMessage("Inside [".__CLASS__."]::[".__FUNCTION__."] Classname[".$classname."]");
        return $classname;
    }

    public static function registerActions(){
        //DSCF_DLM_Utilities::logMessage("Inside [".__CLASS__."]::[".__FUNCTION__."] Screen[".static::SCREEN."]");
    ...
    public static function AddMetaBox() {
        //DSCF_DLM_Utilities::logMessage("Add Meta Box: ".static::KEYNAME);
        add_meta_box(
            static::KEYNAME,
    ...
    */
    public static function renderFromEditorOptions( $postId ){
        ...
        if(class_exists($objectClassname)){
            ...
            //DSCF_DLM_Utilities::logMessage("Inside mb_render: Options: ".print_r($options, true));
    ...
    */
    ...
    public static function saveFromEditorOptions( $postId ){
        ...
        if(class_exists($objectClassname)){
            ...
            $object = DSCF_DLM_StandardEditor::saveEditorChanges($object, $options, $_POST);

            //DSCF_DLM_Utilities::logMessage("mb_save.  Request Object: ".print_r($_REQUEST, true));
            //DSCF_DLM_Utilities::logMessage("mb_save.  MB Object: ".print_r($object, true));
