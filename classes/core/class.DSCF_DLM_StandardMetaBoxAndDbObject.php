 ...
 */
class DSCF_DLM_StandardMetaBoxAndDbObject extends DSCF_DLM_StandardMetaBox{
    ...
    public static function getDataObjectClassName(){
        ...
        DSCF_DLM_Utilities::logError("Class [".static::$dataObjectClassname."] does not exist.  Error.");
    }
    ...
    public static function getDataObject($postId){
        ...
        DSCF_DLM_Utilities::logMessage("DataObject : ".print_r($object, true));
        return $object;
    }
