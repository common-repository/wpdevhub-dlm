 ...
 */
class DSCF_DLM_Chart{

    /*
     * <div id="'+barChart.elemId+'" class="dlm-charts-wrapper-half"></div>
     *
     *
...
jQuery("#"+wrapperId).append('<div id="'+pieChart.elemId+'" class="dlm-charts-wrapper-half"></div>');
DSCF_DLM_Charts.chartsToDo.push(pieChart);
    */
...
jQuery(document).ready(function($) {
    DSCF_DLM_Charts.chartsToDo.push('. json_encode($item)  .');
